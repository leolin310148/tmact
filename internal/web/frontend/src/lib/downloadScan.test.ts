...
describe("scanDownloadablePaths", () => {
  ...
  it("reassembles long paths hard-wrapped by terminal agent output", () => {
    const prefix =
      "/private/tmp/claude-501/-Users-demo-w-lab-moonlight-moonlight-idp/" +
      "12345678-90ab-4cde-8f01-23456789abcd/scratchpad/moonlight-idp-qas-metada";
    const text = [
      "  檔案路徑:",
      `  ${prefix}`,
      "  ta.xml",
  ...
  it("reassembles wrapped command output with an indented continuation", () => {
    const prefix = "/private/tmp/job/scratchpad/moonlight-idp-qa";
