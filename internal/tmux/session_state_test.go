...
func TestParseSessionState(t *testing.T) {
	raw := "work\t1\teditor\tb25f,140x40,0,0{70x40,0,0,1,69x40,71,0,2}\t140\t40\t1\t0\t/workspace/project\t1\n"
	...
	if got.CurrentPath != "/workspace/project" || !got.WindowActive || !got.Active {
