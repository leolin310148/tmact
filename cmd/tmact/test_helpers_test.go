...
func stubCLIHooks(t *testing.T) func() {
	...
	oldLoopRegistryDir := loopRegistryDir
	oldLoopPaneStartCommand := loopPaneStartCommand
	...
	return func() {
		...
		loopRegistryDir = oldLoopRegistryDir
		loopPaneStartCommand = oldLoopPaneStartCommand
